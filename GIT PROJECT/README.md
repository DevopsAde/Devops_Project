...
![Alt text](<Images/Initialize a Git repo.png>)
...
![Alt text](<Images/Create your first git Branch.png>)
...
![Alt text](<Images/Listing your git Branches.png>)
...
![Alt text](<Images/Merging a Branch into another Branch.png>)

## Cont

![Alt text](<Images/Merging a Branch into another Branch Cont..png>)
...
![Alt text](<Images/GitHub Account Created.png>)
...
![Alt text](<Images/Create a new repo.png>)
...
![Alt text](<Images/Pushing your local git repo to remote github repo.png>)
...
![Alt text](<Images/Cloning Remote Git Repo.png>)
